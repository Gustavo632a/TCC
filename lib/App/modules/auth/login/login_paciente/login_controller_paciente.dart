...
class LoginControllerPaciente extends GetxController with LoaderMixin, MessagesMixin {
  ...
  LoginControllerPaciente({
    required AuthRepositoryPaciente authRepository,
  ...
  Future<void> loginpaci({required String cpf, required String password}) async {
    try {
      _loading.toggle();
      final userLogged = await _authRepository.loginpaciente(cpf, password);
